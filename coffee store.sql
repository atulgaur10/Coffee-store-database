...
foreign key (coustmer_id) references coustmers (id)
);
show tables;
...
values ('espersso',2.50,'brazil'),('cappaciuno',3.00,'brazil'),('cold coffee',2.00,'america');
select * from products;
insert into coustmers (first_name,last_name,gender,phone_number)
values('rohan','sharma','M',9475869812),('mohan','goyal','M',8745961523),('monika','rathore','F',56984123785);
select * from orders;
insert into orders(product_id,coustmer_id,order_time)
values(2,1,'2017-08-03 08-00-23');
INSERT INTO coustmers (first_name, last_name, gender, phone_number) 
...
INSERT INTO orders (product_id,coustmer_id,order_time)
 ...
 insert into products (name,price,coffee_origin)
 values('espersso',2.50,'brazil'),('macchiato',3.00,'brazil'),('cappuccino',3.50,'costa rica'),('latte',3.50,'indonesia'),('americano',3.00,'brazil'),('flat white',3.50,'indonesia'),('fliter',3.00,'india');
 select * from products;
 select * from coustmers;
 select * from orders;